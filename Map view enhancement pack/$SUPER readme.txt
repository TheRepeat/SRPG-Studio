There are a bunch of nice plugins being used here:
...
Check out the readme for more info.
 1. detailed-unit-window.js
 2. detailed-unit-window-med-v1.js **OR** detailed-unit-window-med-v2.js
...
Intuitive Seals, which hides units' stats on the combat forecast if the unit(s) in question will be sealed with the 
